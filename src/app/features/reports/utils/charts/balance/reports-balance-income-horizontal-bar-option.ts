...
import type { ReportsBalanceIncomeByClient } from '@shared/models/api/api-reports-balance.model';
...
/** Horizontal Bar — ingresos cobrados por cliente en el periodo. */
export function buildReportsBalanceIncomeHorizontalBarOption(
  rows: readonly ReportsBalanceIncomeByClient[],
): EChartsOption {
